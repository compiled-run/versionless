...
const CAPABILITY_METHOD = [
	'Enumerated from the @versionless/react and @versionless/angular index barrels: seven React modules and forty-seven Angular modules.',
	...
	'angular-eshop-webspa appears as a proving application on the same footing and is likewise absent from the matrix: it is the T023 replacement holdout, an Angular 6.1.4 workspace whose migrated lane is recorded RED. The two capabilities it proves are recorded on that one application and are therefore experimental; nothing here claims the application installs or builds.',
