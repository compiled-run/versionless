...
export function planExcalidrawV011Migration(input: {
	...
	if (
		...
		throw new Error('Excalidraw tree-derived package identity differs');
	...
	if (
		...
		throw new Error('Excalidraw bounded Vite 8 migration differs');
