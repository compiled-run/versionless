...
- Canonical SHA-256: `394fea954c022e94fedd10dbe4ae2df42b2b93a8633fa46574ec82866ffcf716`
- Deterministic core: `754eb300940058babf0ace5e66ce3af3face5699f24d9a6828764c03c5134c87`
- Generated observation: `2026-08-14T07:57:43.637Z`
...
- [Corpus conformance](corpus-conformance.json) — `34dfd66341ac544e8b7ab99024d0fecef9ff3a1d10e03ff385d822d93f0bba4f`; 20 verified verticals grouped into exactly 12 source applications; zero designated pilots are verified.
...
- Holdout `holdout-angular-eshop-webspa` (eShopOnContainers WebSPA, angular lineage): **attempted; outcome migrated-build-green-witness-pending**. Baseline lane green; migrated lane red at install against frozen adapter composite `f1a63359210b87c04408b27cf8c40e88e1b47d44bcc7f5a9be20d9478dc71012` with 0 adapter bytes changed, and green across 2 byte-identical production builds after the authorized T024 Angular-subtree reopen re-frozen at `27741d9c8bfac1b6bb0b330423b1cf258fcde722f548ecb9cf8b389cc98e4234`. Witness journeys: **not-run**; browser proof **not-tested**. Still unproven: **browser behaviour: no witness journey has run in either lane, so the migrated production build is proven to exist and repeat and is proven to do nothing else**. This is **not a passed holdout**, it is **counted in no lineage numerator**, and the earlier RED is published rather than retracted: [evidence/runs/holdout-angular-eshop-webspa/receipt.json](../../../evidence/runs/holdout-angular-eshop-webspa/receipt.json) `a1c43326cb9b0f756e269d0e8339abe64df85a4ce9b709d7c612d37f8e7f0712`.
