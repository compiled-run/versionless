# The versionless evidence program (deep dive)

This is the full, precise record of every proof this repository carries — the document the
README used to be. Nothing here is simplified. If the README is the tour, this is the lab notebook.
